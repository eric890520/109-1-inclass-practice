...
```{r ans11}
# NBA1920Final567
Game5 <- list(date= "Oct. 9",away="Miami Heat",home=" L.A. Lakers", starttime="21:00",timezone= "ET")
Game5
```
```{r}
Game6 <- list(date="Oct. 11",away= "L.A. Lakers",home="Miami Heat", starttime="19:30",timezone= "ET")
Game6
```
```{r}
Game7 <- list(date="Oct. 13", away="Miami Heat", home= "L.A. Lakers", starttime="21:00",timezone= "ET")
Game7
```
```{r}
NBA1920Final567 <- list(Game5=Game5,Game6=Game6,Game7=Game7)
str(NBA1920Final567)
```
...
# G5TimeParsed
G5TimeParsed <-
paste0(Game5$date,Game5$starttime," 2020 ",Game5$timezone)
G5TimeParsed
```
...
```{r ans14}
# TpeJason
tpejason <- ymd_hm("2020-10-09 21:00" ,tz="")
tpejason
```
